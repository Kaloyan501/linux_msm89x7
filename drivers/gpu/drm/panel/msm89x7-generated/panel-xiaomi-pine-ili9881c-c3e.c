...
static int ili9881cplus_c3e_on(struct ili9881cplus_c3e *ctx)
{
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x06, 0x10);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x07, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xff, 0x98, 0x81, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x03, 0x6e);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x04, 0x16);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x05, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x00, 0x25);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x01, 0x32);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x36, 0xbe);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x33, 0xb5);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x32, 0x77);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x31, 0x78);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x30, 0x39);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x2f, 0x3a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x2e, 0x3b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x2d, 0x3d);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x2c, 0x3d);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x29, 0x29);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x28, 0x32);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x27, 0x33);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x26, 0x34);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x24, 0x39);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x23, 0x3c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x22, 0x3c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x20, 0x3e);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xff, 0x98, 0x81, 0x0b);
...
{
	return drm_connector_helper_get_modes_fixed(connector, &ili9881cplus_c3e_mode);
}
...
static const struct of_device_id ili9881cplus_c3e_of_match[] = {
	{ .compatible = "xiaomi,pine-ili9881c-c3e" }, // FIXME
	{ /* sentinel */ }
};
...
static struct mipi_dsi_driver ili9881cplus_c3e_driver = {
	...
	.driver = {
		.name = "panel-xiaomi-pine-ili9881c-c3e",
