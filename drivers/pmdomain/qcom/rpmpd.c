...
/* Sleep only is not supported yet
static struct rpmpd mx_s2a_level_so = {
	.pd = { .name = "mx_so", },
	.peer = &mx_s2a_lvl,
	.sleep_only = true,
	.res_type = RPMPD_SMPA,
...
static struct rpmpd md_s6a_lvl_ao;
...
static struct rpmpd *sdm429w_rpmpds[] = {
	...
	[SDM429W_VDDMD_AO] =	&md_s6a_lvl_ao,
...
//	[SDM429W_VDDMX_SO] =	&mx_s2a_lvl_so, // Sleep Only is not supported
};
